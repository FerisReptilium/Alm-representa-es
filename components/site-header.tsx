  ...
  return (
    <>
      <div className="announcement">
        <span>Representação Febella Makeup</span><span className="announcementDot">•</span><span>Frete estimado pelo CEP</span><span className="announcementDot">•</span><span>Atendimento pelo WhatsApp</span>
      </div>
      <header className="siteHeader">
        <div className="headerMain container">
          ...
          <a className="brand" href="#" aria-label="Página inicial"><span className="brandMain">ALM</span><span className="brandSub">BEAUTY · MAKEUP · REPRESENTAÇÕES</span></a>
