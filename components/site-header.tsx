    ...
    <>
      ...
      <header className="siteHeader">
        <div className="headerMain container">
          ...
          <a className="brand brandWithLogo" href="#" aria-label="Página inicial ALM Representações">
            <img src="/brand/alm-logo-final.webp" alt="ALM Representações" className="brandLogo" />
          </a>
      ...
      <div className={`mobileDrawer ${open ? "isOpen" : ""}`} aria-hidden={!open}>
        ...
        <aside className="drawerPanel">
          <div className="drawerHeader"><img src="/brand/alm-logo-final.webp" alt="ALM Representações" className="drawerLogo"/><button className="iconButton" onClick={() => setOpen(false)} aria-label="Fechar">×</button></div>
